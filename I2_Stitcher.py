...
def start():
    ...
    if not os.path.exists('Corners/I2'):
        os.makedirs('Corners/I2')
    cv2.imwrite('Corners/I2/Corresponding_corners.jpg', blank_image)
    ...
    if not os.path.exists('Transformed_Images/I2'):
        os.makedirs('Transformed_Images/I2')

    cv2.imwrite('Transformed_Images/I2/' + filename0, blank_image_0)
    cv2.imwrite('Transformed_Images/I2/' + filename1, blank_image_1)
    cv2.imwrite('Transformed_Images/I2/' + filename2, blank_image_2)
    cv2.imwrite('Transformed_Images/I2/' + filename3, blank_image_3)
    cv2.imwrite('Transformed_Images/I2/' + filename4, blank_image_4)


    if not os.path.exists('Homography_Matrices/I2'):
        os.makedirs('Homography_Matrices/I2')
    np.savetxt('Homography_Matrices/I2/homography_02.txt', homo_02)
    np.savetxt('Homography_Matrices/I2/homography_12.txt', homo_12)
    np.savetxt('Homography_Matrices/I2/homography_22.txt', homo_22)
    np.savetxt('Homography_Matrices/I2/homography_32.txt', homo_32)
    np.savetxt('Homography_Matrices/I2/homography_42.txt', homo_42)



    np.savetxt('Corners/I2/corners0.txt', transformed_corners_0.flatten())
    np.savetxt('Corners/I2/corners1.txt', transformed_corners_1.flatten())
    np.savetxt('Corners/I2/corners2.txt', image2_corners.flatten())
    np.savetxt('Corners/I2/corners3.txt', transformed_corners_3.flatten())
    np.savetxt('Corners/I2/corners4.txt', transformed_corners_4.flatten())

    img0 = cv2.imread('Transformed_Images/I2/' + filename0)
    img1 = cv2.imread('Transformed_Images/I2/' + filename1)
    img2 = cv2.imread('Transformed_Images/I2/' + filename2)
    img3 = cv2.imread('Transformed_Images/I2/' + filename3)
    img4 = cv2.imread('Transformed_Images/I2/' + filename4)
    ...
    # Save the image
    cv2.imwrite('Results/I2_filtered.jpg', smoothened_img)
