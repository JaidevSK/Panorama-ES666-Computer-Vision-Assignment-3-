...
def start():
    ...
    if not os.path.exists('Corners/I3'):
        os.makedirs('Corners/I3')
    cv2.imwrite('Corners/I3/Corresponding_corners.jpg', blank_image)
    ...
    if not os.path.exists('Transformed_Images/I3'):
        os.makedirs('Transformed_Images/I3')

    cv2.imwrite('Transformed_Images/I3/' + filename0, blank_image_0)
    cv2.imwrite('Transformed_Images/I3/' + filename1, blank_image_1)
    cv2.imwrite('Transformed_Images/I3/' + filename2, blank_image_2)
    cv2.imwrite('Transformed_Images/I3/' + filename3, blank_image_3)
    cv2.imwrite('Transformed_Images/I3/' + filename4, blank_image_4)

    if not os.path.exists('Homography_Matrices/I3'):
        os.makedirs('Homography_Matrices/I3')
    np.savetxt('Homography_Matrices/I3/homography_02.txt', homo_02)
    np.savetxt('Homography_Matrices/I3/homography_12.txt', homo_12)
    np.savetxt('Homography_Matrices/I3/homography_22.txt', homo_22)
    np.savetxt('Homography_Matrices/I3/homography_32.txt', homo_32)
    np.savetxt('Homography_Matrices/I3/homography_42.txt', homo_42)


    np.savetxt('Corners/I3/corners0.txt', transformed_corners_0.flatten())
    np.savetxt('Corners/I3/corners1.txt', transformed_corners_1.flatten())
    np.savetxt('Corners/I3/corners2.txt', image2_corners.flatten())
    np.savetxt('Corners/I3/corners3.txt', transformed_corners_3.flatten())
    np.savetxt('Corners/I3/corners4.txt', transformed_corners_4.flatten())

    img0 = cv2.imread('Transformed_Images/I3/' + filename0)
    img1 = cv2.imread('Transformed_Images/I3/' + filename1)
    img2 = cv2.imread('Transformed_Images/I3/' + filename2)
    img3 = cv2.imread('Transformed_Images/I3/' + filename3)
    img4 = cv2.imread('Transformed_Images/I3/' + filename4)
    ...
    cv2.imwrite('Results/I3_filtered.jpg', smoothened_img)
    cv2.imwrite('Results/I3.jpg', result)
