...
def start():
    ...
    for i in range(4):
        cv2.circle(blank_image, (int(image0_corners[i][0][0]), int(image0_corners[i][0][1])), 5, (255, 0, 0), -1)

    for i in range(4):
        cv2.line(blank_image, (int(image0_corners[i][0][0]), int(image0_corners[i][0][1])), (int(image0_corners[(i+1)%4][0][0]), int(image0_corners[(i+1)%4][0][1])), (255, 0, 0), 5)

    for i in range(4):
        cv2.circle(blank_image, (int(image1_corners[i][0][0]), int(image1_corners[i][0][1])), 5, (0, 255, 0), -1)

    for i in range(4):
        cv2.line(blank_image, (int(image1_corners[i][0][0]), int(image1_corners[i][0][1])), (int(image1_corners[(i+1)%4][0][0]), int(image1_corners[(i+1)%4][0][1])), (0, 255, 0), 5)

    for i in range(4):
        cv2.circle(blank_image, (int(image2_corners[i][0][0]), int(image2_corners[i][0][1])), 5, (0, 0, 255), -1)

    for i in range(4):
        cv2.line(blank_image, (int(image2_corners[i][0][0]), int(image2_corners[i][0][1])), (int(image2_corners[(i+1)%4][0][0]), int(image2_corners[(i+1)%4][0][1])), (0, 0, 255), 5)

    for i in range(4):
        cv2.circle(blank_image, (int(image3_corners[i][0][0]), int(image3_corners[i][0][1])), 5, (255, 255, 0), -1)

    for i in range(4):
        cv2.line(blank_image, (int(image3_corners[i][0][0]), int(image3_corners[i][0][1])), (int(image3_corners[(i+1)%4][0][0]), int(image3_corners[(i+1)%4][0][1])), (255, 255, 0), 5)

    for i in range(4):
        cv2.circle(blank_image, (int(image4_corners[i][0][0]), int(image4_corners[i][0][1])), 5, (0, 255, 255), -1)

    for i in range(4):
        cv2.line(blank_image, (int(image4_corners[i][0][0]), int(image4_corners[i][0][1])), (int(image4_corners[(i+1)%4][0][0]), int(image4_corners[(i+1)%4][0][1])), (0, 255, 255), 5)
    ...
    if not os.path.exists('Corners/I6'):
        os.makedirs('Corners/I6')
    cv2.imwrite('Corners/I6/Corresponding_corners.jpg', blank_image)
    ...
    if not os.path.exists('Transformed_Images/I6'):
        os.makedirs('Transformed_Images/I6')

    cv2.imwrite('Transformed_Images/I6/' + filename0, blank_image_0)
    cv2.imwrite('Transformed_Images/I6/' + filename1, blank_image_1)
    cv2.imwrite('Transformed_Images/I6/' + filename2, blank_image_2)
    cv2.imwrite('Transformed_Images/I6/' + filename3, blank_image_3)
    cv2.imwrite('Transformed_Images/I6/' + filename4, blank_image_4)

    if not os.path.exists('Homography_Matrices/I6'):
        os.makedirs('Homography_Matrices/I6')
    np.savetxt('Homography_Matrices/I6/homography_02.txt', homo_02)
    np.savetxt('Homography_Matrices/I6/homography_12.txt', homo_12)
    np.savetxt('Homography_Matrices/I6/homography_22.txt', homo_22)
    np.savetxt('Homography_Matrices/I6/homography_32.txt', homo_32)
    np.savetxt('Homography_Matrices/I6/homography_42.txt', homo_42)


    np.savetxt('Corners/I6/corners0.txt', transformed_corners_0.flatten())
    np.savetxt('Corners/I6/corners1.txt', transformed_corners_1.flatten())
    np.savetxt('Corners/I6/corners2.txt', image2_corners.flatten())
    np.savetxt('Corners/I6/corners3.txt', transformed_corners_3.flatten())
    np.savetxt('Corners/I6/corners4.txt', transformed_corners_4.flatten())

    img0 = cv2.imread('Transformed_Images/I6/' + filename0)
    img1 = cv2.imread('Transformed_Images/I6/' + filename1)
    img2 = cv2.imread('Transformed_Images/I6/' + filename2)
    img3 = cv2.imread('Transformed_Images/I6/' + filename3)
    img4 = cv2.imread('Transformed_Images/I6/' + filename4)
    ...
    # plt.figure()
    smoothened_img = cv2.medianBlur(result, 3)
    # plt.imshow(smoothened_img)

    cv2.imwrite('Results/I6_filtered.jpg', smoothened_img)
    cv2.imwrite('Results/I6.jpg', result)
